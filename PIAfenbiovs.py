...
'''*******************************************************
   12.             TENDENCIA LINEAL
*******************************************************'''
x = np.array([ 298,  586,  878, 1167, 1454, 1735, 2009, 2299, 2591, 2888, 3183])
y = diff
plt.scatter(x,y)
...
x = np.linspace(media - 3*dsvest, media + 3*dsvest, 100)
plt.plot(x, stats.norm.pdf(x, media, dsvest))
plt.show()
